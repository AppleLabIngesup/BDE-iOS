...
-(IBAction)segementButton:(id)sender{
    ...
    switch (onglets.selectedSegmentIndex) {
        case 0:{
            ...
            NSDictionary *desc4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"Lorem ipsum dolor sit amet, consectetuer adipiscing",@"cat",@"desc-soiree-min.png",@"img",nil];
        ...
        case 1:{
            ...
            NSDictionary *desc = [[NSDictionary alloc] initWithObjectsAndKeys:@"Lorem ipsum dolor sit amet, consectetuer adipiscing",@"cat",@"desc-soiree-min.png",@"img",nil];
            NSDictionary *desc1 = [[NSDictionary alloc] initWithObjectsAndKeys:@"Lorem ipsum dolor sit amet, consectetuer adipiscing",@"cat",@"desc-soiree-min.png",@"img",nil];
            NSDictionary *desc4 = [[NSDictionary alloc] initWithObjectsAndKeys:@"Lorem ipsum dolor sit amet, consectetuer adipiscing",@"cat",@"soiree-poker-min",@"img",nil];
