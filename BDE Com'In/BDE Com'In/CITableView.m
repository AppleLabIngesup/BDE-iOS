...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil) {
        //cell = [[UITableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
        NSArray *xib = [[NSBundle mainBundle] loadNibNamed:@"CICellCustomAlbum" owner:self options:nil];
    ...
    NSDictionary *current = [albums objectAtIndex:indexPath.row];
    
    cell.pictureAlbum.image = [UIImage imageNamed:@"noImage.png"];
    cell.pictureAlbum1.image = [UIImage imageNamed:@"noImage.png"];
    return cell;
}
